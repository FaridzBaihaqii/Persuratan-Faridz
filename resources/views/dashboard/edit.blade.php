                        ...
                        <div class="col-md-5">
                            ...
                            <div class="form-group">
                                ...
                                <select name="id_jenis_surat" class="form-control">
                                    ...
                                    <option value="{{ $jenis->id_jenis_surat }}" {{ $jenis->id_jenis_surat == $surat->id_jenis_surat ? 'selected' : '' }}>
                                        {{ $jenis->jenis_surat }}
                                    </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="ringkasan" value="{{ $surat->ringkasan }}" />
                            </div>
                            <div class="form-group">
