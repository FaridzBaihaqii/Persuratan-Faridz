...
Route::middleware(['auth'])->group(function () {
    ...
    // DASHBOARD
    Route::prefix('dashboard')->middleware(['UserAccess:admin,operator'])->group(function () {
    ...
    // JENIS SURAT
    Route::prefix('jenis')->middleware(['UserAccess:admin'])->group(function () {
    ...
    // TRANSAKSI SURAT
    Route::prefix('transaksi')->middleware(['UserAccess:admin,operator'])->group(function () {
